<template>
        ...
        <div class="login-container">
          <div class="card">
            ...
            <div class="card-footer text-center">
              <p class="mb-0">Henüz mağaza hesabınız yok mu? <a href="/store-application" class="text-decoration-none">Hemen başvurun</a></p>
            </div>
          </div>
        </div>
      </div>
  ...
  const handleLogin = async () => {
    ...
    try {
      await apiClient.post('/auth/store-login', {
        email: email.value,
      ...
      if (error.response && error.response.status === 401) {
        ...
        loginError.value = 'Giriş yapılırken bir hata oluştu. Lütfen daha sonra tekrar deneyin.';
      }
    } finally {
